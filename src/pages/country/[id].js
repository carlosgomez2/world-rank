            ...
            <div className={styles.container}>
                ...
                <div className={styles.container_right}>
                    <div className={styles.details_panel}>
                        ...
                        <div className={styles.details_panel_row}>
                            <div className={styles.details_panel_label}>Domain Name</div>
                            <div className={styles.details_panel_value}>{country.topLevelDomain.map((item) => item).join(', ')}</div>
                        </div>

                        <div className={styles.details_panel_row}>
                            <div className={styles.details_panel_label}>Timezones</div>
                            <div className={styles.details_panel_value}>{country.timezones.map((item) => item).join(', ')}</div>
                        </div>
                        ...
                        <div className={styles.details_panel_row}>
                            <div className={styles.details_panel_label}>Demonym</div>
                            <div className={styles.details_panel_value}>{country.demonym}</div>
                        </div>
